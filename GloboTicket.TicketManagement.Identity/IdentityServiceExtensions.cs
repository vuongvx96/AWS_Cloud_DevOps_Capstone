...
namespace GloboTicket.TicketManagement.Identity
{
    public static class IdentityServiceExtensions
    {
        public static void AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                var connetionString = configuration.GetConnectionString("GloboTicketIdentityConnectionString");
                options.UseMySql(connetionString, ServerVersion.AutoDetect(connetionString), b => b.MigrationsAssembly(typeof(GloboTicketIdentityDbContext).Assembly.FullName));
            });
